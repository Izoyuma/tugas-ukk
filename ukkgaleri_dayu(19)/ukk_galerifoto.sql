...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@google.com', 'kamunanyak', 'adadeh');
...
ALTER TABLE `likefoto`
  ...
  ADD CONSTRAINT `likefoto_ibfk_2` FOREIGN KEY (`likeid`) REFERENCES `foto` (`fotoid`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
